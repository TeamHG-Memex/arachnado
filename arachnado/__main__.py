...
def main(port, host, start_manhole, manhole_port, manhole_host, loglevel,
    ...
    from arachnado.crawler.crawlerprocess import ArachnadoCrawlerProcess
    ...
    job_storage = MongoStorage(
        getenv(opts['arachnado.mongo_export']['jobs_mongo_uri_env']) or
        opts['arachnado.mongo_export']['jobs_mongo_uri'],
    )
